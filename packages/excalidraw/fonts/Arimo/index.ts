...
// import Cyrilic from "./Arimo-VariableFont_wght-XRXI3I6Li01BKofiOc5wtlZ2di8HDIkhdTQ3j6zbXWjABC.woff2";
import Latin from "./Arimo-VariableFont_wght-XRXI3I6Li01BKofiOc5wtlZ2di8HDIkhdTQ3j6zbXWjABC.woff2";
...
export const ArimoFontFaces: ExcalidrawFontFaceDescriptor[] = [
  // {
  //   uri: CyrilicExt,
  //   descriptors: {
